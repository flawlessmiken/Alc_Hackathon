 ...
 */
package com.example.alc_hackathon;
...
public class MainActivity extends AppCompatActivity {
  ...
  private void initializePlayer() {
    ...
    String media_url_dash = "https://ia600309.us.archive.org/28/items/Mp3Songs_175/golmaal3-05www.songs.pk.mp3";
    MediaSource mediaSource = buildMediaSource(Uri.parse(media_url_dash));
